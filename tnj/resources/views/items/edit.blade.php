<x-layout>
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        <header class="text-center">
            ...
            <p class="mb-4">Add notes, change the status, etc</p>
        </header>
           ...
           {{--  
            ...
            <div class="mb-6">
                ...
                <input
                    type="file"
                    class="border border-gray-200 rounded p-2 w-full"
                    value="{{$item['job_description_upload']}}"
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{$item['how_did_you_find_it']}}"
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{$item['telephone_interview_date']}}"
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{$item['first_onsite_interview_date']}}"
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{$item['offer_received_date']}}"
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{$item['offer_accepted_date']}}"
            ...
            <div class="mb-6">
                ...
                <a href="/items/{{$item['id']}}" class="text-black ml-4 hover:text-colOne"> Back </a>
            </div>
        </form>
    </x-card>
</x-layout>